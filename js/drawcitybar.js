function drawcitybar(){
    ...
    if (selected_city == 'All'){
        ...
        if(selected_in_or_out == 'in'){
            ...
            //比例尺
            var w = d3.select('.bar-chart').node().clientWidth;
            var h = d3.select('.bar-chart').node().clientHeight;
            ...
            .tickValues([1,5,10,50,100,500,1000,5000,10000,50000,100000,500000,1000000,5000000])
